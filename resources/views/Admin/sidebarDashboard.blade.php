    ...
    <nav x-data="{selected: $persist('Dashboard')}">
          ...
          <li>
              ...
              <div class="overflow-hidden transform translate" :class="(selected === 'E-Commerce') ? 'block' :'hidden'">
                  <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                      <li>
                          <a href="/admin/products" class="menu-dropdown-item group" :class="page === 'products' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"> Products </a>
                      </li>
                      <li>
                          <a href="/admin/categories" class="menu-dropdown-item group" :class="page === 'categories' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"> Categories </a>
                      </li>
                  </ul>
              </div>
              <!-- Dropdown Menu End -->
      ...
      <div>
          ...
          <ul class="flex flex-col gap-4 mb-6">
              ...
              <!-- Menu Item Users -->
              <li>
                  <a href="/admin/users" class="menu-item group" :class=" (selected === 'Users') || (page === 'users') ? 'menu-item-active' : 'menu-item-inactive'">
      ...
      <div>
          ...
          <ul class="flex flex-col gap-4 mb-6">
              <!-- Menu Item Feedbacks -->
              <li>
                  <a href="/admin/feedbacks" class="menu-item group" :class=" (selected === 'Feedbacks') || (page === 'feedbacks') ? 'menu-item-active' : 'menu-item-inactive'">
