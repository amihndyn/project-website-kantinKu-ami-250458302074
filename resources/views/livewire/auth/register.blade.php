    ...
    <div class="p-8 md:p-12 lg:p-16 flex flex-col justify-center order-2">
      ...
      <form class="space-y-5">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="text" class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0C2B4E] focus:border-transparent transition duration-200" placeholder="Masukkan nama lengkap">
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="email" class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0C2B4E] focus:border-transparent transition duration-200" placeholder="nama@email.com">
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="text" class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0C2B4E] focus:border-transparent transition duration-200" placeholder="Masukkan NIM">
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="password" class="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0C2B4E] focus:border-transparent transition duration-200" placeholder="Masukkan kata sandi">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="password" class="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0C2B4E] focus:border-transparent transition duration-200" placeholder="Konfirmasi kata sandi">
            <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 hover:text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
      ...
      <div class="mt-8 text-center">
        <p class="text-sm text-gray-600 dark:text-gray-400">
          Sudah punya akun?
          <a href="/signIn" wire:navigate class="font-medium text-[#8FABD4] hover:text-[#0C2B4E] transition duration-200">Masuk di sini</a>
        </p>
      </div>
    </div>
  </div>
